...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        sans: ['Inter', '-apple-system', 'BlinkMacSystemFont', 'SF Pro Text', 'SF Pro Rounded', 'sans-serif'],
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { opacity: "0.5", boxShadow: "0 0 20px hsla(189, 77%, 44%, 0.3)" },
          "50%": { opacity: "1", boxShadow: "0 0 40px hsla(189, 77%, 44%, 0.5)" },
        },
      },
      animation: {
