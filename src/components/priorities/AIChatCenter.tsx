...
export function AIChatCenter() {
  ...
  return (
    <div className="rounded-[32px] bg-gradient-to-br from-white/80 to-white/60 backdrop-blur-xl border border-[#12AFCB]/20 p-4 sm:p-8 animate-fade-in flex flex-col h-full overflow-y-auto">
      {/* AI Icon */}
