...
export function SmartCards({ globalGoals, temporaryGoals, plans, onAddGlobal, onAddPlan }: SmartCardsProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Card 3 - This Week */}
      <div className="rounded-[32px] bg-gradient-to-br from-white/80 to-white/60 backdrop-blur-xl border border-[#12AFCB]/20 p-6 shadow-[0_4px_12px_rgba(18,175,203,0.15)] hover:shadow-[0_8px_20px_rgba(18,175,203,0.2)] hover:scale-[1.02] transition-all duration-300 h-[280px] flex flex-col">
        <div className="flex items-center gap-2 mb-4">
      ...
      {/* Card 4 - Plans */}
      <div className="rounded-[32px] bg-gradient-to-br from-white/80 to-white/60 backdrop-blur-xl border border-[#12AFCB]/20 p-6 shadow-[0_4px_12px_rgba(18,175,203,0.15)] hover:shadow-[0_8px_20px_rgba(18,175,203,0.2)] hover:scale-[1.02] transition-all duration-300 h-[220px] flex flex-col">
        <div className="flex items-center justify-between mb-4">
