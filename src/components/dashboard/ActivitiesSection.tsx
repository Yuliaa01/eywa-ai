                ...
                <button
                  ...
                  className={`relative p-4 rounded-xl text-left transition-all ${
                    selectedAISuggestion === index
                      ? "bg-white border-2 border-[#12AFCB] shadow-[0_4px_16px_rgba(18,175,203,0.15)] scale-[1.02]"
                      : "bg-white/60 backdrop-blur-sm border border-white/40 hover:border-[#12AFCB]/30 hover:bg-white/80 hover:scale-[1.01]"
                  }`}
                >
                  {selectedAISuggestion === index && (
                    <div className="absolute top-3 right-3 w-5 h-5 rounded-full bg-gradient-to-r from-[#12AFCB] to-[#19D0E4] flex items-center justify-center">
                  ...
                  <p className="text-xs text-[#5A6B7F] mb-3 line-clamp-2">{suggestion.benefit}</p>
