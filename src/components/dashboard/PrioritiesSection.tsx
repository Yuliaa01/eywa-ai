...
export default function PrioritiesSection() {
  ...
  const renderGlobalGoalsCard = () => (
    <div className="rounded-[32px] bg-gradient-to-br from-white/80 to-white/60 backdrop-blur-xl border border-[#12AFCB]/20 p-6 h-[210px] flex flex-col">
  ...
  const renderThisWeekCard = () => (
    <div className="rounded-[32px] bg-gradient-to-br from-white/80 to-white/60 backdrop-blur-xl border border-[#12AFCB]/20 p-6 h-[220px] flex flex-col">
      <div className="flex items-center gap-2 mb-4">
