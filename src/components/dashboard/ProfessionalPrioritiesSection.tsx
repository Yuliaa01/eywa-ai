...
export default function ProfessionalPrioritiesSection() {
  ...
  const bodyMetrics = [
    ...
    { icon: <Activity className="w-4 h-4" />, title: "Temperature", value: bodyMetricsData.temperature, unit: "°C", timestamp: "Last recorded", trendData: generateTrendData(), hasData: bodyMetricsData.temperature !== "--", badge: bodyMetricsData.temperature === "--" ? "No data" : undefined, chartType: "wave" as ChartType, color: "#F59E0B" },
