        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-12">
            <FeatureCard 
              ...
              description="Real-time vitals and biomarker monitoring"
              color="primary"
            />
            <FeatureCard 
            ...
            <FeatureCard 
              ...
              description="Optimize your biological age"
              color="secondary"
            />
          </div>
        </div>
...
const FeatureCard = ({ icon, title, description, color }: FeatureCardProps) => {
  ...
  return (
    <div className="group relative p-6 rounded-2xl bg-gradient-card border border-border shadow-card hover:shadow-elevated transition-smooth backdrop-blur-sm">
