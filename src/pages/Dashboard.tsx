    ...
    <div className="h-screen flex flex-col bg-background overflow-hidden">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          {/* Tab Navigation */}
          <TabsList className="fixed top-[120px] z-10 left-1/2 -translate-x-1/2 w-[calc(100%-3rem)] max-w-[calc(80rem-3rem)] grid grid-cols-4 bg-card/60 backdrop-blur-xl border border-border p-1.5 rounded-3xl h-auto">
            <TabsTrigger
              value="priorities"
