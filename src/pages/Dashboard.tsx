    ...
    <div className="h-screen flex flex-col bg-background overflow-hidden">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          {/* Tab Navigation */}
          <TabsList className="fixed top-[88px] left-0 right-0 z-10 max-w-7xl mx-auto grid grid-cols-4 bg-card/95 backdrop-blur-xl border border-border p-1.5 rounded-3xl h-auto mb-6">
            <TabsTrigger
              value="priorities"
